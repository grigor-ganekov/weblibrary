					...
					<div class="row">
						<div class="4u">
							<div id="sidebar">
								...
								</header> <span class="image featured"><img src="images/pic09.jpg"
									alt="unrellevent" /></span> </section>
						...
						<div class="8u important(collapse)">
							<div id="content">
								...
								<article>
								<form action="search">
									<input type="text" name="search" style="width: 50%" /> <select
								...
								<p>
									Publisher:
									<%=theBook.getPublisher()%></p>
								<br />
								<p>
									Year of publishing:
									<%=theBook.getYearOfPublishing()%></p>
								<br />
								<p>
									ISBN:
									<%=theBook.getISBN()%></p>
								...
								<form method="post" action="delete">
									<input style="background-color: #e31818" type="submit"
										value="Изтрий книгата"> <input type="hidden" name="id"
										value="<%=theBook.getId()%>">
								</form>
